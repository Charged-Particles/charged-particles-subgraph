...
export class GenericWalletManagerB__dischargeResult {
  value0: BigInt;
  value1: BigInt;
...
export class GenericWalletManagerB__dischargeAmountResult {
  value0: BigInt;
  value1: BigInt;
...
export class GenericWalletManagerB__getInterestResult {
  value0: BigInt;
  value1: BigInt;
...
export class GenericWalletManagerB__releaseResult {
  value0: BigInt;
  value1: BigInt;
  value2: BigInt;
...
export class GenericWalletManagerB__releaseAmountResult {
  value0: BigInt;
  value1: BigInt;
  value2: BigInt;
...
export class GenericWalletManagerB extends ethereum.SmartContract {
  static bind(address: Address): GenericWalletManagerB {
    return new GenericWalletManagerB("GenericWalletManagerB", address);
  }
  ...
  discharge(
    ...
    param3: Address,
    param4: Address
  ): GenericWalletManagerB__dischargeResult {
    ...
    return new GenericWalletManagerB__dischargeResult(
      result[0].toBigInt(),
      result[1].toBigInt()
    );
  }
  ...
  try_discharge(
    ...
    param3: Address,
    param4: Address
  ): ethereum.CallResult<GenericWalletManagerB__dischargeResult> {
    ...
    return ethereum.CallResult.fromValue(
      new GenericWalletManagerB__dischargeResult(
        value[0].toBigInt(),
        value[1].toBigInt()
      )
    );
  ...
  dischargeAmount(
    ...
    param4: BigInt,
    param5: Address
  ): GenericWalletManagerB__dischargeAmountResult {
    let result = super.call(
      "dischargeAmount",
    ...
    return new GenericWalletManagerB__dischargeAmountResult(
      result[0].toBigInt(),
      result[1].toBigInt()
    );
  }
  ...
  try_dischargeAmount(
    ...
    param4: BigInt,
    param5: Address
  ): ethereum.CallResult<GenericWalletManagerB__dischargeAmountResult> {
    let result = super.tryCall(
      "dischargeAmount",
      "dischargeAmount(address,address,uint256,address,uint256,address):(uint256,uint256)",
      [
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      new GenericWalletManagerB__dischargeAmountResult(
        value[0].toBigInt(),
        value[1].toBigInt()
      )
    );
  ...
  getInterest(
    ...
    tokenId: BigInt,
    assetToken: Address
  ): GenericWalletManagerB__getInterestResult {
    let result = super.call(
      "getInterest",
    ...
    return new GenericWalletManagerB__getInterestResult(
      result[0].toBigInt(),
      result[1].toBigInt()
    );
  }
  ...
  try_getInterest(
    ...
    tokenId: BigInt,
    assetToken: Address
  ): ethereum.CallResult<GenericWalletManagerB__getInterestResult> {
    let result = super.tryCall(
      "getInterest",
      "getInterest(address,uint256,address):(uint256,uint256)",
      [
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      new GenericWalletManagerB__getInterestResult(
        value[0].toBigInt(),
        value[1].toBigInt()
      )
    );
  ...
  release(
  ...
  ): GenericWalletManagerB__releaseResult {
    let result = super.call(
      "release",
    ...
    return new GenericWalletManagerB__releaseResult(
      result[0].toBigInt(),
      result[1].toBigInt(),
      result[2].toBigInt()
    );
  ...
  try_release(
    ...
    assetToken: Address,
    creatorRedirect: Address
  ): ethereum.CallResult<GenericWalletManagerB__releaseResult> {
    let result = super.tryCall(
      "release",
      "release(address,address,uint256,address,address):(uint256,uint256,uint256)",
      [
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      new GenericWalletManagerB__releaseResult(
        value[0].toBigInt(),
        value[1].toBigInt(),
        value[2].toBigInt()
      )
  ...
  releaseAmount(
    ...
    assetAmount: BigInt,
    creatorRedirect: Address
  ): GenericWalletManagerB__releaseAmountResult {
    let result = super.call(
      "releaseAmount",
    ...
    return new GenericWalletManagerB__releaseAmountResult(
      result[0].toBigInt(),
      result[1].toBigInt(),
      result[2].toBigInt()
    );
  ...
  try_releaseAmount(
    ...
    assetAmount: BigInt,
    creatorRedirect: Address
  ): ethereum.CallResult<GenericWalletManagerB__releaseAmountResult> {
    let result = super.tryCall(
      "releaseAmount",
      "releaseAmount(address,address,uint256,address,uint256,address):(uint256,uint256,uint256)",
      [
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      new GenericWalletManagerB__releaseAmountResult(
        value[0].toBigInt(),
        value[1].toBigInt(),
        value[2].toBigInt()
      )
