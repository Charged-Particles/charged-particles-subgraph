...
export class GenericWalletManager__releaseResult {
  value0: BigInt;
  value1: BigInt;
  value2: BigInt;
...
export class GenericWalletManager extends ethereum.SmartContract {
  ...
  discharge(
    ...
    return new GenericWalletManager__dischargeResult(
      result[0].toBigInt(),
      result[1].toBigInt()
    );
  }
  ...
  try_discharge(
    ...
    return ethereum.CallResult.fromValue(
      new GenericWalletManager__dischargeResult(
        value[0].toBigInt(),
        value[1].toBigInt()
      )
    );
  ...
  dischargeAmount(
    ...
    return new GenericWalletManager__dischargeAmountResult(
      result[0].toBigInt(),
      result[1].toBigInt()
    );
  }
  ...
  try_dischargeAmount(
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      new GenericWalletManager__dischargeAmountResult(
        value[0].toBigInt(),
        value[1].toBigInt()
      )
    );
  ...
  getInterest(
    ...
    tokenId: BigInt,
    assetToken: Address
  ): GenericWalletManager__getInterestResult {
    let result = super.call(
      "getInterest",
    ...
    return new GenericWalletManager__getInterestResult(
      result[0].toBigInt(),
      result[1].toBigInt()
    );
  }
  ...
  try_getInterest(
    ...
    tokenId: BigInt,
    assetToken: Address
  ): ethereum.CallResult<GenericWalletManager__getInterestResult> {
    let result = super.tryCall(
      "getInterest",
      "getInterest(address,uint256,address):(uint256,uint256)",
      [
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      new GenericWalletManager__getInterestResult(
        value[0].toBigInt(),
        value[1].toBigInt()
      )
    );
  ...
  release(
    ...
    return new GenericWalletManager__releaseResult(
      result[0].toBigInt(),
      result[1].toBigInt(),
      result[2].toBigInt()
    );
